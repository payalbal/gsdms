...
## Optional indices:
# CREATE INDEX db_country_idx ON public.clean_gbif USING btree (countrycode);
# CREATE INDEX db_taxclass_idx ON public.clean_gbif USING btree (taxclass);
# CREATE INDEX db_taxfamily_idx ON public.clean_gbif USING btree (taxfamily);
# CREATE INDEX db_taxorder_idx ON public.clean_gbif USING btree (taxorder);
# CREATE INDEX db_phylum_idx ON public.clean_gbif USING btree (phylum);
